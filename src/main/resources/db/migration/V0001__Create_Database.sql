...
create table cliente (id integer not null auto_increment, cpfoucnpj varchar(255), email varchar(255), nome varchar(255), status bit, telefone varchar(255), tenant_id integer, primary key (id)) engine=InnoDB;
...
create table log_sistema (id integer not null auto_increment, comando varchar(255), datagravacao datetime, email_usuario varchar(255), status bit, categoria_id integer , cliente_id integer , empresa_id integer , estoque_id integer , pedido_id integer , permissao_id integer , produto_id integer , tenant_id integer, usuario_id integer , primary key (id)) engine=InnoDB;
...
alter table log_sistema add constraint FK1ujvq0rtdaabgc3juvhjtsbtl foreign key (estoque_id) references estoque (id);
